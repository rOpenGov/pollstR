...
**NOTE: The current dev version is backwards incompatible. Huffpost Pollster upgraded their [API]( http://elections.huffingtonpost.com/pollster/api/v2) and pollstR was rewritten from scratch for it**
