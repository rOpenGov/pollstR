...
##  $ estimates:'data.frame':	1047 obs. of  8 variables:
##   ..$ choice         : chr [1:1047] "Romney" "Paul" "Santorum" "Gingrich" ...
##   ..$ value          : num [1:1047] 22.5 21.3 15.9 12.6 11.1 8.3 3.7 5.9 0.9 39.6 ...
##   ..$ lead_confidence: num [1:1047] NA NA NA NA NA NA NA NA NA NA ...
##   ..$ first_name     : chr [1:1047] "Mitt" "Ron" "Rick" "Newt" ...
##   ..$ last_name      : chr [1:1047] "Romney" "Paul" "Santorum" "Gingrich" ...
##   ..$ party          : Factor w/ 6 levels "Dem","Gre","ind",..: 6 6 6 6 6 6 6 NA NA 6 ...
##   ..$ incumbent      : logi [1:1047] FALSE FALSE FALSE FALSE FALSE FALSE ...
##   ..$ slug           : chr [1:1047] "2012-iowa-gop-primary" "2012-iowa-gop-primary" "2012-iowa-gop-primary" "2012-iowa-gop-primary" ...
